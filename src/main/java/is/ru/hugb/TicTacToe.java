...
public class TicTacToe {
	...
	public static void main(String[] args) {
        ...
        player1 = choosePlayer(player1, reader);
        ...
        while(true){
            ...
            //SKoðar hvort einhver hafi unnið og brýtur síðan while ef einhver vann
    ...
    public static String choosePlayer(String player1, Scanner reader){
