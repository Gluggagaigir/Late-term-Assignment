...
public class TicTacToe {
  ...
  public static void main(String[] args) {
    ...
    public  static Boolean findAndPlaceInField(char player, String tempNum, char[] field){
        if(!checkStringInput(tempNum)){ //if string is not valid
            return false;
        }
    ...
    public static Boolean openFile(){
      try{
        x = new Scanner(new File("src/ratpack/templates/index.html"));
          ...
          System.out.println("Could not open index.html");
          return false;
      }
      return true;
    }
    ...
    try{
       x.close();
          ...
          System.out.println("Could not close index.html");
          return false;
      }
      return true;
    }
